...
//        stateManager.attach(new VideoRecorderAppState());
        ...
        SpriteRenderState renderState = new SpriteRenderState(rootNode, new DeferredLightingSpriteLoader(assetManager));
        stateManager.attach(renderState);
        ...
        ed.setComponents(center, new Position(0, 0), new Scale(1.5f, 1.5f), new Rotation(0f), new SpriteComponent("scifiwall/scifiwall.jpg"));
        ...
        ed.setComponents(light1, new Scale(0.07f, 0.07f), new Rotation(0f), new SpriteComponent("light.png"), new RenderComponent());

        light2 = ed.createEntity();
        ed.setComponents(light2, new PointLightComponent(1.5f, ColorRGBA.Orange, 0.3f));
        ed.setComponents(light2, new Scale(0.1f, 0.1f), new Rotation(0f), new SpriteComponent("light.png"), new RenderComponent());

        animatedSprite = ed.createEntity();
        ed.setComponents(animatedSprite, new Position(0, 0), new Scale(0.5f, 0.5f), new Rotation(0f), new SpriteComponent("animationTest.png"), new RenderComponent(0));
